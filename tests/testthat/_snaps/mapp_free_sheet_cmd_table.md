# snapshot of (the structure of) mapp_free_sheet_cmd_table()
    ...
    # A tibble: 23 x 4
       ...
       <chr>          <chr>  <chr>          <list>              
     1 3              #COMP  x              <tibble[,5] [1 x 5]>
     2 4              #IF    abc            <tibble[,5] [1 x 5]>
     3 5_1            #IF    kq5            <tibble[,5] [1 x 5]>
     4 5_2            #IF    kq6            <tibble[,5] [1 x 5]>
     5 7, 8, 9, 10_1  #REC   kq1            <tibble[,5] [4 x 5]>
     6 7, 8, 9, 10_2  #REC   kq3            <tibble[,5] [4 x 5]>
     7 12             #KG    kq1_q2_renamed <tibble[,5] [1 x 5]>
     8 13             #COMP  n              <tibble[,5] [1 x 5]>
     9 14             #VARL  n              <tibble[,5] [1 x 5]>
    10 16, 17, 18, 19 #VALL  n              <tibble[,5] [4 x 5]>
    # ... with 13 more rows

---

    tibble[,4] [23 x 4] (S3: tbl_df/tbl/data.frame)
     $ row    : chr [1:23] "3" "4" "5_1" "5_2" ...
     $ action : chr [1:23] "#COMP" "#IF" "#IF" "#IF" ...
     $ new_var: chr [1:23] "x" "abc" "kq5" "kq6" ...
     $ data   :List of 23
      ..$ : tibble[,5] [1 x 5] (S3: tbl_df/tbl/data.frame)
      .. ..$ X1: chr "#COMP"
      .. ..$ X2: chr "x"
      .. ..$ X3: chr "q1 == 2"
      .. ..$ X4: chr NA
      ...
      .. ..$ X4: chr NA
      .. ..$ X5: chr NA
      ..$ : tibble[,5] [4 x 5] (S3: tbl_df/tbl/data.frame)
      ...
      ..$ : tibble[,5] [2 x 5] (S3: tbl_df/tbl/data.frame)
      .. ..$ X1: chr [1:2] "#AVALL" "."
      .. ..$ X2: chr [1:2] "n" "4"
