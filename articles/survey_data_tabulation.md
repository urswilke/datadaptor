...
[`library`](https://rdrr.io/r/base/library.html)`(`[`stringr`](https://stringr.tidyverse.org)`)`\
[`suppressMessages`](https://rdrr.io/r/base/message.html)`(`[`library`](https://rdrr.io/r/base/library.html)`(`[`dplyr`](https://dplyr.tidyverse.org)`)``)`
...
\
`v`` ``<-`` ``haven``::`[`labelled`](https://haven.tidyverse.org/reference/labelled.html)`(`\
`  ``1``:``3``,`\
...
\
[`str`](https://rdrr.io/r/utils/str.html)`(``v``)`\
`#>  int+lbl [1:3] 1, 2, 3`\
...
\
[`attr`](https://rdrr.io/r/base/attr.html)`(``v``, ``"label"``)`\
...
\
[`attr`](https://rdrr.io/r/base/attr.html)`(``v``, ``"labels"``)`\
...
\
[`tibble`](https://tibble.tidyverse.org/reference/tibble.html)`(``v``)`\
`#> ``# A tibble: 3 × 1`\
`#>   v                         `\
`#>   ``<int+lbl>``                 `\
...
`#> ``# A tibble: 0 × 0`\
`q1`` ``<-`` ``haven``::`[`labelled`](https://haven.tidyverse.org/reference/labelled.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(``18``:``88``, ``10``, ``TRUE``)``, label ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"what's your age?"``)``, labels ``=`` ``NULL``)`\
`q2`` ``<-`` ``haven``::`[`labelled`](https://haven.tidyverse.org/reference/labelled.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``NA``, ``1``:``3``)``, ``10``, ``TRUE``)``, label ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"What's your gender?"``)``, labels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``male ``=`` ``1``, female ``=`` ``2``, ``"non-binary"`` ``=`` ``3``)``)`\
`q3_1`` ``<-`` ``haven``::`[`labelled`](https://haven.tidyverse.org/reference/labelled.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(``0``:``1``, ``10``, ``TRUE``)``, label ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Select all that applies - I'm curious"``)``, labels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``unselected ``=`` ``0``, selected ``=`` ``1``)``)`\
`q3_2`` ``<-`` ``haven``::`[`labelled`](https://haven.tidyverse.org/reference/labelled.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(``0``:``1``, ``10``, ``TRUE``)``, label ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Select all that applies - I'm cautios"``)``, labels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``unselected ``=`` ``0``, selected ``=`` ``1``)``)`\
`q3_3`` ``<-`` ``haven``::`[`labelled`](https://haven.tidyverse.org/reference/labelled.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(``0``:``1``, ``10``, ``TRUE``)``, label ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Select all that applies - I'm lazy"``)``, labels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``unselected ``=`` ``0``, selected ``=`` ``1``)``)`\
`q3_4`` ``<-`` ``haven``::`[`labelled`](https://haven.tidyverse.org/reference/labelled.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(``0``:``1``, ``10``, ``TRUE``)``, label ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Select all that applies - I don't care"``)``, labels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``unselected ``=`` ``0``, selected ``=`` ``1``)``)`\
`q4_vallabs`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``"1 = I like it"`` ``=`` ``1``, ``"2"`` ``=`` ``2``, ``"3"`` ``=`` ``3``, ``"4"`` ``=`` ``4``, ``` "5 = I don`t like it at all" ``` ``=`` ``5``)`\
`q4_answers`` ``<-`\
`  ``q4_text`` ``<-`` ``` 'Please rate the following items from 1 = "I really like it" to 5 = "I don`t like it at all' ``\
`q4_1`` ``<-`` ``haven``::`[`labelled`](https://haven.tidyverse.org/reference/labelled.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(``1``:``5``, ``10``, ``TRUE``)``, label ``=`` `[`paste`](https://rdrr.io/r/base/paste.html)`(``q4_text``, ``"Sports"``, sep ``=`` ``" - "``)``, labels ``=`` ``q4_vallabs``)`\
`q4_2`` ``<-`` ``haven``::`[`labelled`](https://haven.tidyverse.org/reference/labelled.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(``1``:``5``, ``10``, ``TRUE``)``, label ``=`` `[`paste`](https://rdrr.io/r/base/paste.html)`(``q4_text``, ``"Watching TV"``, sep ``=`` ``" - "``)``, labels ``=`` ``q4_vallabs``)`\
`q4_3`` ``<-`` ``haven``::`[`labelled`](https://haven.tidyverse.org/reference/labelled.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(``1``:``5``, ``10``, ``TRUE``)``, label ``=`` `[`paste`](https://rdrr.io/r/base/paste.html)`(``q4_text``, ``"Reading"``, sep ``=`` ``" - "``)``, labels ``=`` ``q4_vallabs``)`\
\
`df`` ``<-`` `[`tibble`](https://tibble.tidyverse.org/reference/tibble.html)`(``id ``=`` ``1``:``10``, ``q1``, ``q2``, ``q3_1``, ``q3_2``, ``q3_3``, ``q3_4``, ``q4_1``, ``q4_2``, ``q4_3``)`
...
\
[`attr`](https://rdrr.io/r/base/attr.html)`(``q3_1``, ``"labels"``)`\
`#> unselected   selected `\
`#>          0          1`
...
\
`df`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`count`](https://dplyr.tidyverse.org/reference/count.html)`(``q1``)`\
`#> ``# A tibble: 9 × 2`\
`#>   q1            n`\
`#>   ``<int+lbl>`` ``<int>`\
`#> ``1`` 31            2`\
...
\
[`mean`](https://rdrr.io/r/base/mean.html)`(``q1``)`\
`#> [1] 57.6`\
[`median`](https://rdrr.io/r/stats/median.html)`(``q1``)`\
`#> [1] 59.5`
...
\
[`attr`](https://rdrr.io/r/base/attr.html)`(``q1``, ``"label"``)`\
`#> [1] "what's your age?"`
...
\
`df`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`count`](https://dplyr.tidyverse.org/reference/count.html)`(``q2``)`\
`#> ``# A tibble: 4 × 2`\
`#>   q2                  n`\
`#>   ``<int+lbl>``       ``<int>`\
`#> ``1``  1`` [male]``           1`\
...
\
`df``$``q2``[`[`is.na`](https://rdrr.io/r/base/NA.html)`(``df``$``q2``)``]`` ``<-`` ``4`
...
\
[`attr`](https://rdrr.io/r/base/attr.html)`(``df``$``q2``, ``"labels"``)`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(`\
`  `[`attr`](https://rdrr.io/r/base/attr.html)`(``df``$``q2``, ``"labels"``)``,`\
`  ``"No answer"`` ``=`` ``4`\
`)`
...
\
`df`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`count`](https://dplyr.tidyverse.org/reference/count.html)`(``q3_1``)`\
`#> ``# A tibble: 2 × 2`\
`#>   q3_1               n`\
`#>   ``<int+lbl>``      ``<int>`\
`#> ``1`` 0`` [unselected]``     6`\
`#> ``2`` 1`` [selected]``       4`\
`df`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`count`](https://dplyr.tidyverse.org/reference/count.html)`(``q3_2``)`\
`#> ``# A tibble: 2 × 2`\
`#>   q3_2               n`\
`#>   ``<int+lbl>``      ``<int>`\
`#> ``1`` 0`` [unselected]``     6`\
...
\
`df_q3`` ``<-`` ``df`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`select`](https://dplyr.tidyverse.org/reference/select.html)`(``q3_1``:``q3_4``)`\
`df_q3`\
`#> ``# A tibble: 10 × 4`\
`#>    q3_1           q3_2           q3_3           q3_4          `\
...
\
`df_q3_long`` ``<-`` ``df_q3`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)\
`  `[`pivot_longer`](https://tidyr.tidyverse.org/reference/pivot_longer.html)`(`[`everything`](https://tidyselect.r-lib.org/reference/everything.html)`(``)``, names_to ``=`` ``"var"``)`\
`df_q3_long`\
`#> ``# A tibble: 40 × 2`\
`#>    var   value         `\
`#>    ``<chr>`` ``<int+lbl>``     `\
...
\
`df_q3_long`` ``<-`` ``df_q3_long`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)\
`  `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``value`` ``==`` ``1``)`\
`df_q3_long`\
`#> ``# A tibble: 15 × 2`\
`#>    var   value       `\
`#>    ``<chr>`` ``<int+lbl>``   `\
...
\
`df_q3_counts`` ``<-`` ``df_q3_long`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`count`](https://dplyr.tidyverse.org/reference/count.html)`(``var``)`\
`df_q3_counts`\
`#> ``# A tibble: 4 × 2`\
`#>   var       n`\
`#>   ``<chr>`` ``<int>`\
...
\
`varlabs`` ``<-`` ``df_q3`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`gen_var_table`](https://urswilke.codeberg.page/datadaptor/reference/label_tables.md)`(``)`\
`varlabs`\
`#> ``# A tibble: 4 × 7`\
...
\
`varlabs`` ``<-`` ``varlabs`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`mutate`](https://dplyr.tidyverse.org/reference/mutate.html)`(``varlab ``=`` `[`str_remove`](https://stringr.tidyverse.org/reference/str_remove.html)`(``varlab``, ``".* - "``)``)`\
`varlabs`\
`#> ``# A tibble: 4 × 7`\
`#>   var   type    varlab       new_label new_name op    hash                      `\
`#>   ``<chr>`` ``<chr>``   ``<chr>``        ``<chr>``     ``<chr>``    ``<chr>`` ``<chr>``                     `\
...
\
`df`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`count`](https://dplyr.tidyverse.org/reference/count.html)`(``q4_1``)`\
`#> ``# A tibble: 5 × 2`\
`#>   q4_1                               n`\
`#>   ``<int+lbl>``                      ``<int>`\
`#> ``1`` 1`` [1 = I like it]``                  3`\
...
\
`df_q4`` ``<-`` ``df`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)\
`  `[`select`](https://dplyr.tidyverse.org/reference/select.html)`(``q4_1``:``q4_3``)`\
`df_q4_means`` ``<-`` ``df_q4`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)\
`  `[`pivot_longer`](https://tidyr.tidyverse.org/reference/pivot_longer.html)`(`[`everything`](https://tidyselect.r-lib.org/reference/everything.html)`(``)``, names_to ``=`` ``"var"``)`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)\
`  `[`group_by`](https://dplyr.tidyverse.org/reference/group_by.html)`(``var``)`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)\
`  `[`summarise`](https://dplyr.tidyverse.org/reference/summarise.html)`(``mean ``=`` `[`mean`](https://rdrr.io/r/base/mean.html)`(``value``)``)`\
`df_q4_means`\
`#> ``# A tibble: 3 × 2`\
`#>   var    mean`\
`#>   ``<chr>`` ``<dbl>`\
...
\
`varlabs`` ``<-`` ``df_q4`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`gen_var_table`](https://urswilke.codeberg.page/datadaptor/reference/label_tables.md)`(``)`\
`varlabs`` ``<-`` ``varlabs`` `[`%>%`](https://urswilke.codeberg.page/datadaptor/reference/pipe.md)` `[`mutate`](https://dplyr.tidyverse.org/reference/mutate.html)`(``varlab ``=`` `[`str_remove`](https://stringr.tidyverse.org/reference/str_remove.html)`(``varlab``, ``".* - "``)``)`\
`varlabs`\
`#> ``# A tibble: 3 × 7`\
`#>   var   type    varlab      new_label new_name op    hash                       `\
